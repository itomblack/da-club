 ...
 */
	...
	NLForm.prototype = {
		_init : function() {
			...
			// document.getElementById('main-content').addEventListener( 'click', function(ev) { self._closeFlds(); } );
			// window.overlay.addEventListener( 'touchstart', function(ev) { self._closeFlds(); } );
		},
		_closeFlds : function() {
			if( this.fldOpen !== -1 ) {
